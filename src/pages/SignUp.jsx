      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="flex flex-wrap gap-2 justify-center mb-8">
          {perks.map(p => (
            <span
              key={p}
              className="flex items-center gap-1.5 text-xs text-white/40 px-3 py-1.5 rounded-full border border-blue-500/10"
              style={{ background: 'rgba(37,99,235,0.05)' }}
            >
              <Check className="w-3 h-3 text-blue-400 shrink-0" /> {p}
            </span>
          ))}
        </div>
